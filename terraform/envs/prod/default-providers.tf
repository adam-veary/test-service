...
locals {
  ...
  domains_global_account_id_param    = "/xometry/accounts/global/XometryDomainsProdEngineering"
  domains_gov_account_id_param       = "/xometry/accounts/govcloud/XometryGovDomainsProdEngineering"
  managed_global_cluster             = "managed-global-${local.env}"
  domains_ds_global_account_id_param = "/xometry/accounts/global/XometryDomainsProdDataScience"
  domains_ds_gov_account_id_param    = "/xometry/accounts/govcloud/XometryGovDomainsProdDataScience"
...
variable "global_aws_access_key" {
  type        = string
  description = "AWS Access Key ID for the XomGlobal Prod Account"
}

variable "global_aws_secret_key" {
  type        = string
  description = "AWS Access Key Secret for the XomGlobal Prod Account"
}
...
################################################################################
# Kubernetes: managed-global-prod
################################################################################
