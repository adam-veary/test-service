...
locals {
  ...
  domains_global_account_id_param    = "/xometry/accounts/global/XometryDomainsStageEngineering"
  domains_gov_account_id_param       = "/xometry/accounts/govcloud/XometryGovDomainsStageEngineering"
  managed_global_cluster             = "managed-global-${local.env}"
  domains_ds_global_account_id_param = "/xometry/accounts/global/XometryDomainsStageDataScience"
  domains_ds_gov_account_id_param    = "/xometry/accounts/govcloud/XometryGovDomainsStageDataScience"
...
variable "global_aws_access_key" {
  type        = string
  description = "AWS Access Key ID for the XomGlobal Stage Account"
}

variable "global_aws_secret_key" {
  type        = string
  description = "AWS Access Key Secret for the XomGlobal Stage Account"
}
...
################################################################################
# Kubernetes: managed-global-stage
################################################################################
